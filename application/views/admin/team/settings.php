      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card card-dark">
              ...
              <!-- form start -->
              <?php 
                $attributes = array('name' => 'frm_team_settings','method' => 'post' );
                $hidden = array('txt_id' => $record->ts_id);
                echo form_open_multipart('admin/team/settings', $attributes, $hidden); 
              ...
              ?>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label>Select Team Members Show on Home Page <span class="ml-1 text-red" > *</span></label>
                    <select name="ddl_items_show" class="form-control">
                        ...
                        <option value="20" <?php if($record->items_show==20) echo "selected"; else ""; ?>>20</option>
