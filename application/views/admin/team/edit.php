        ...
        <div class="row">
          ...
          <div class="card card-dark">
              ...
              <?php 
                ...
                $hidden = array('txt_id' => $record->te_id);
                echo form_open_multipart('admin/team/edit', $attributes, $hidden); 
              ...
              ?>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="txt_facebook" class="form-control" placeholder="Facebook Profile" value="<?php echo $record->facebook; ?>">
                  </div>

                  <div class="form-group">
                    <label>Twitter Profile</label>
                    <input type="text" name="txt_twitter" class="form-control" placeholder="Twitter Profile" value="<?php echo $record->twitter; ?>">
                  </div>
                  
                  <div class="form-group">
                    <label>Instagram Profile</label>
                    <input type="text" name="txt_instagram" class="form-control" placeholder="Instagram Profile" value="<?php echo $record->instagram; ?>">
                  </div>

                  <div class="form-group">
                    <label>Linkedin Profile</label>
                    <input type="text" name="txt_linkedin" class="form-control" placeholder="Linkedin Profile" value="<?php echo $record->linkedin; ?>">
                  </div>
