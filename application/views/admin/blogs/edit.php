      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card card-dark">
              ...
              <!-- form start -->
              <?php 
                $attributes = array('name' => 'frm_blogs_edit','method' => 'post' );
                $hidden = array('txt_id' => $record->bo_id);
                echo form_open_multipart('admin/blogs/edit', $attributes, $hidden); 
              ...
              ?>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <select name="ddl_category" class="form-control">
                        ...
                        foreach($records_cat->result() as $row) { ?>
                          <option value="<?php echo $row->bc_id ?>" <?php if($record->bc_id == $row->bc_id) echo "selected"; else echo ""; ?>><?php echo stripslashes($row->title); ?></option>
                        <?php } ?>
                    </select>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="txt_meta_title" class="form-control" placeholder="Meta Keywords" value="<?php echo $record->meta_title; ?>">
                  </div>

                  <div class="form-group">
                    <label>Meta Keywords</label>
                    <input type="text" name="txt_meta_keywords" class="form-control" placeholder="Meta Keywords" value="<?php echo $record->meta_keywords; ?>">
                  </div>

                  <div class="form-group">
                    <label>Meta Description</label>
                    <input type="text" name="txt_meta_description" class="form-control" placeholder="Meta Description" value="<?php echo $record->meta_description; ?>">
                  </div>
