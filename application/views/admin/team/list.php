        ...
        <div class="row">
          ...
          <div class="card card-dark">
              <div class="card-header">
                ...
                <div class="float-right"><a href="<?php echo base_url('admin/team/add'); ?>" class="btn btn-block btn-info btn-sm">Add New</a></div>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                ...
                <div class="card-body">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo base_url('admin/team/edit/'.$row->te_id); ?>" class="btn" title="Edit"><i class="fas fa-edit"></i> </a>

                        <a class="btn delete" title="Delete" data-id="<?php echo base_url('admin/team/delete/'.$row->te_id); ?>"><i class="fas fa-trash"></i> </a>
                      </td>
                    </tr>
                    <?php } ?>
                  </tbody>
