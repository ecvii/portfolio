<div class="tab-pane fade" id="testimonials" role="tabpanel" aria-labelledby="testimonials-tab">
            ...
            ?>
            <section class="section-padding testimonials bg-overlay-dark animated bounceInUp flex-centering" style="background-image: url('<?php echo $testimonials_bg; ?>');" id="<?php echo $testimonials_module->module_file; ?>">
                <div class="container sh-above text-white-persist-e text-center position-relative">
                    <div class="row">
                        <div class="col-12 text-center">
                        <div class="heading heading-margin">
                            <div class="heading-absolute text-white-c sh-above"><span><?php if($testimonials_title[0]!="") echo $testimonials_title[0]; ?></span></div>
                            <h1 class="sh-above2 position-relative">
                                <span class="heading-border primary-color-border primary-color">                                
                                <?php if($testimonials_title[0]!="") echo $testimonials_title[0]; ?>
                                </span> 
                                <?php 
                                    
                                    for($i=1; $i<count($testimonials_title); $i++) {
                                        echo $testimonials_title[$i]." ";
                                    }
                                ?>
                            </h1>
                        </div><!-- end heading -->
                        <p class="text-black-5 para-margin"><?php echo $testimonials_module->sub_title; ?></p>
                        </div><!-- end column -->
                    </div><!-- end row -->
                    <div class="row">
