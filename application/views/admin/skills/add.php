      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card card-dark">
              ...
              <!-- form start -->
              <?php 
                $attributes = array('name' => 'frm_skills_add','method' => 'post' );
                echo form_open_multipart('admin/skills/add', $attributes); 
              ?>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" min="1" max="100" name="txt_level" class="form-control" placeholder="Level" value="<?php echo $this->input->post('txt_level') ?>">
                  </div>                
