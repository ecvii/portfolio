<!-- team Starts  -->
    <section class="section-padding team <?php if($count_module==0) echo 'bg-white'; else echo 'blogs bg-white-e' ?>" id="<?php echo $team_module->module_file; ?>">
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    ...
                    <p class="text-black-5 para-margin"><?php echo $team_module->sub_title; ?>
                    </p>
                </div><!-- end column -->
            </div><!-- end row -->
