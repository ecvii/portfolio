      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card card-dark">
              ...
              <!-- form start -->
              <?php 
                $attributes = array('name' => 'frm_skills_edit','method' => 'post' );
                $hidden = array('txt_id' => $record->sk_id);
                echo form_open_multipart('admin/skills/edit', $attributes, $hidden); 
              ...
              ?>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label>Level <span class="ml-1 text-red" > *</span></label>
                    <input type="number" min="1" max="100" name="txt_level" class="form-control" placeholder="Level" value="<?php echo $record->level; ?>">
                  </div>
