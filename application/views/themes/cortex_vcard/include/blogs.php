<div class="tab-pane fade" id="<?php echo $blogs_module->module_file; ?>" role="tabpanel" aria-labelledby="blog-tab">
            <!-- Blogs Starts  -->
            <section class="section-padding blogs animated bounceInUp" id="<?php echo $blogs_module->module_file; ?>">
                <div class="container">
                    <div class="row">
                        ...
                        <p class="text-black-5 para-margin"><?php echo $blogs_module->module_file; ?></p>
                        </div><!-- end column -->
                    </div><!-- end row -->
                    <div class="row">
            ...
            <?php } ?>
                    ...
                    <div class="view-btn text-center text-center mt-5">
                        <a href="<?php echo base_url('blogs-list/'); ?>"
                            class="btn bg-primary-color on-bg-color bg-primary-borderh br0 mt-4 px-4">View All Posts</a>
                    </div><!-- end view-btn -->
                </div><!-- end container -->
            </section>
            <!-- Blogs Ends  -->
