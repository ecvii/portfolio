      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card card-dark">
              ...
              <!-- form start -->
              <?php 
                $attributes = array('name' => 'frm_facts_add','method' => 'post' );
                echo form_open_multipart('admin/profile/facts/add', $attributes); 
              ?>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label>Value</label>
                    <input type="text" name="txt_value" class="form-control" placeholder="Value" value="<?php echo $this->input->post('txt_value') ?>"> 
                  </div>

                  <div class="form-group">
                    <label>Font Awesome Icon</label>
                    <input type="text" name="txt_icon" class="form-control" placeholder="Font Awesome Icon" value="<?php echo $this->input->post('txt_icon') ?>">
                  </div>
