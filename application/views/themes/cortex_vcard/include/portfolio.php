<div class="tab-pane fade" id="<?php echo $portfolio_module->module_file; ?>" role="tabpanel" aria-labelledby="portfolio-tab">
            <!-- Portfolio Starts  -->
            <section class="section-padding portfolio position-relative overflow-hidden animated bounceInUp"
                id="portfolio">
