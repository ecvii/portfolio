      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card card-dark">
              ...
              <!-- form start -->
              <?php 
                $attributes = array('name' => 'frm_experience_add','method' => 'post' );
                echo form_open_multipart('admin/experience/add', $attributes); 
              ?>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="txt_company" class="form-control" placeholder="Company" value="<?php echo $this->input->post('txt_company') ?>">
                  </div>
