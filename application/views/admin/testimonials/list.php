        ...
        <div class="row">
          ...
          <div class="card card-dark">
              <div class="card-header">
                ...
                <div class="float-right"><a href="<?php echo base_url('admin/testimonials/add'); ?>" class="btn btn-block btn-info btn-sm">Add New</a></div>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                ...
                <div class="card-body">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo base_url('admin/testimonials/edit/'.$row->tm_id); ?>" class="btn" title="Edit"><i class="fas fa-edit"></i> </a>

                        <a class="btn delete" title="Delete" data-id="<?php echo base_url('admin/testimonials/delete/'.$row->tm_id); ?>"><i class="fas fa-trash"></i> </a>
                      </td>
                    </tr>
                    <?php } ?>
                  </tbody>
