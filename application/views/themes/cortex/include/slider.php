...
<div class="parallax-bg" id="home"> 
    <div class="meta vh-100 bg-overlay" style="background: url(<?php echo $slider_path; ?>);background-size: cover;background-position: center;background-repeat: no-repeat;">
