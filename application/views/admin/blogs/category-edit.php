      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card card-dark">
              ...
              <!-- form start -->
              <?php 
                $attributes = array('name' => 'frm_blog_cat_edit','method' => 'post' );
                $hidden = array('txt_id' => $record->bc_id);
                echo form_open_multipart('admin/blogs/category/edit', $attributes, $hidden); 
