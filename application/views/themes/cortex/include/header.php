...
<?php if($selected_theme->theme_style_selected=='simple') { ?>
<!-- Navbar Starts-->
<header>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-xl-auto ml-auto fs-nav-link primary-colorh" id="navbarNavDropdown">
                        ...
                        <li class="nav-item">
                            <a class="nav-link px-3 hover active" href="<?php echo base_url('index.html'); ?>#home">Home <span
    ...
    <?php if($selected_theme->theme_style_selected=='sidebar') { ?>
          <!-- sidenav Starts -->
    <section>
        ...
        <div class="sidenav bg-white shadow">
            ...
            <ul class="list-unstyled mb-0 lsp1 text-black sidenav-active">
                ...
                <?php foreach($menu_items->result() as $menu_row) { ?>
                    <li class="nav-item"><a href="<?php echo base_url('index.html#').$menu_row->module_file; ?>" class="nav-link bg-primary-colorh"><?php echo stripslashes($menu_row->menu_title); ?> <i class="<?php echo $menu_row->menu_icon; ?>"></i>
                    </a></li>
                <?php } ?>
