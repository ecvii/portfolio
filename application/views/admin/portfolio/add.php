      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card card-dark">
              ...
              <!-- form start -->
              <?php 
                $attributes = array('name' => 'frm_portfolio_add','method' => 'post' );
                echo form_open_multipart('admin/portfolio/add', $attributes); 
              ?>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <select name="ddl_category" class="form-control">
                        ...
                        foreach($records_cat->result() as $row) { ?>
                          <option value="<?php echo $row->pc_id ?>"><?php echo stripslashes($row->title); ?></option>
                        <?php } ?>
                    </select>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="txt_link" class="form-control" placeholder="Link" value="<?php echo $this->input->post('txt_link') ?>">
                  </div>
                  
                  <div class="form-group">
                    <label>Details</label>
                    <textarea type="text" name="txt_details" class="form-control" placeholder="Details"><?php echo $this->input->post('txt_details') ?></textarea>
                  </div>
