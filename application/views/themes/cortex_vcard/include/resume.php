<div class="tab-pane fade" id="resume" role="tabpanel" aria-labelledby="resume-tab">
            <!-- resume Start  -->
            <section class="section-padding resume animated bounceInUp" id="<?php echo $resume_module->module_file; ?>">
                <div class="container">
                    <div class="row">
                    ...
                    <ul class="nav nav-tabs border-0 heading-margin" id="myTab" role="tablist">
                        <li class="nav-item w-50 primary-colorh text-black">
                            <a class="nav-link bg-white hover lsp1 shadow active" id="experience-tab" data-toggle="tab"
                                data-target="#experience" role="tab" aria-controls="experience"
                                aria-selected="true">Experience</a>
                        </li>
                        <li class="nav-item w-50 primary-colorh text-black">
                            <a class="nav-link bg-white hover lsp1 shadow " id="education-tab" data-toggle="tab"
